...
class Blog {
    ...
    <div class="uk-card-footer uk-clearfix">
        <div class="uk-float-left">
            <span class="uk-label uk-label-warning in-label-small">${category}</span>
        </div>
        <div class="uk-float-right">
            <a href="${this.sanitizePath}/${link}" class="uk-button uk-button-text">Read more<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
        </div>
    </div>
</article>`
    }
